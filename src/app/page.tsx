...
// Projets fake personnalisables
const fakeProjects = [
  {
    title: "Bijouterie Dorkel",
    description: "Site vitrine pour une bijouterie.",
    image: "/Bijouterie.png",
    tags: ["WordPress", "Bootstrap", "Sass", "PHP"],
    link: "https://www.bijouteriedorkel.com",
  },
  {
    title: "Agence d'Immobilier",
    description: "Annonces pour des biens immobiliers à la vente",
    image: "/Immobilier.png",
    tags: ["WordPress", "Bootstrap", "Sass", "PHP"],
    link: "https://cleonieimmobilier.fr/",
  },
  {
    title: "Chateau de Versailleux",
    description: "Site vitrine pour un lieux de fêtes",
    image: "/Chateau.png",
    tags: ["WordPress", "Bootstrap", "Sass", "PHP"],
    link: "https://www.chateaudeversailleux.com/",
  },
]
                ...
                <>
                  <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl overflow-hidden border border-gray-200/50 group-hover:border-slate-400 transition-all duration-500 group-hover:scale-[1.02] shadow-xl hover:shadow-2xl">
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <div className="flex flex-wrap gap-1 sm:gap-2 mb-2 sm:mb-4">
                        {project.tags.map((tag) => (
                          <span key={tag} className="px-2 sm:px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-600 font-medium">{tag}</span>
                        ))}
                      </div>
                      {project.link && (
                        <span className="inline-flex items-center gap-1 sm:gap-2 text-slate-800 hover:text-slate-400 font-medium group/link text-sm sm:text-base cursor-pointer">
